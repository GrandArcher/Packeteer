...
The CI lab (`lab/e2e.sh`, GitHub Actions job `e2e`) peers this image with FRR and checks that an injected route appears, is withdrawn when FRR drops the native route, and is withdrawn when Packeteer stops. See [lab/README.md](lab/README.md).
